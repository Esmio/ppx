...
class WithdrawalRecord extends Component {
  ...
  componentWillMount() {
    this.dispatch({ type: 'transactionModel/updateState', payload: { type: 'WITHDRAWAL' } });    
      ...
      return _.map(currentList, (listItem) => {
        ...
        return (
          <tr key={transactionId}>
            ...
            <td
              data-align="right"
              style={{ color: isCompleted ? accentCinnabar : '' }}
            >
...
const mapStatesToProps = ({ transactionModel, dataTableModel }) => {
