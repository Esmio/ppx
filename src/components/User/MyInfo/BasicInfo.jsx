...
class BasicInfo extends Component {
  ...
  componentWillMount() {
    ...
    dispatch({ type: 'userModel/getLoginHistory' });
  }
  ...
  componentWillUnmount() {
    ...
    dispatch({
      ...
      payload: [
        'nickname', 'realName', 'phoneNumber', 'email', 'responseMsg'
      ]
    });
  }
    ...
    return (
      <div className={css.profile_inputInlineRow}>
        ...
        { editTarget === 'nickname' ?
            <button
              disabled={value}
              onClick={this.onEditTarget.bind(this, '')}
  ...
  render() {
    ...
    return (
      <div>
        <div className={css.profile_contentBody}>
          <div className={css.profile_accountProfileRow} style={{ marginBottom: '1rem' }}>
            ...
            <div className={css.profile_accountProfileInfo}>
              <p>{ username }</p>
              <p className={css.profile_accountProfileLoginTime}>最后登陆 { signInTime }</p>
            </div>
          </div>
        ...
        <div className={css.profile_contentBody}>
          <h4 className={css.profile_formLabel}>登陆历史</h4>
...
const mapStatesToProps = ({ userModel, formModel, layoutModel }) => {
  ...
  const { userData, loginHistory } = userModel;
  return { userData, loginHistory, shouldShowProfileModal, ...formModel };
};
