...
import { OrangeButton, MDIcon } from '../../General';
      ...
      <div className={css.profile_radioRow}>
        ...
        <button
          ...
          className={
            ...
            css.profile_radioBtn__checked : 
            css.profile_radioBtn
          }
        >
          <MDIcon
            iconName={
      ...
      <div>
        <div className={css.profile_contentBody}>
          <h4 className={css.profile_formLabel}>
            修改{securityMode === TYPE.SECURITY_PASSWORD ? '提款' : '登陆'}密码
          </h4>          
          { this.renderOptions() }
          { this.renderForm() }
        </div>
        ...
        <div className={css.profile_formBtnRow}>
          ...
          <OrangeButton
            ...
            placeholder={`更新${securityMode === TYPE.SECURITY_PASSWORD ? '提款' : '登陆'}密码`}
          />
        </div>
      </div>
    );
